...
- This references an [InitialRequirements.md](./docs/InitialRequirements.md) document that was the initial specification for the application.  Claude then built and executed an implementation plan from this, plus a small amount of corrective prompting, which is all documented.  A [FurtherRequirements](./docs/FurtherRequirements.md) document was added to create an extended V2 of the application.
